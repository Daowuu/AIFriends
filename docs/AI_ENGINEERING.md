...
AIFriends 当前不是通用 Agent，不是工具平台，也不是知识问答产品。  
它的 AI 核心目标是：
...
- TTS 不是孤立配置
- 它建立在 DashScope 音频链路可用的前提上

---

## 6. Conversation Layer 详细逻辑
...
## 11. Studio 在 AI 工程里的职责

Studio 不是普通后台，而是创作者实验台。
...
原因不是这些没价值，而是它们不是当前角色能力提升的最短路径。

---

## 15. 一句话结论

AIFriends 当前 AI 工程的重点不是“让 AI 做更多事”，而是：
